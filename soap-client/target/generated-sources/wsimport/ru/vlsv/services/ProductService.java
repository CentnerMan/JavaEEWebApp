 ...
 * 
 */
@WebServiceClient(name = "ProductService", targetNamespace = "http://services.vlsv.ru/", wsdlLocation = "http://localhost:8080/JavaEEWebApp/ProductService/ProductServiceLocalImpl?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PRODUCTSERVICE_QNAME = new QName("http://services.vlsv.ru/", "ProductService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/JavaEEWebApp/ProductService/ProductServiceLocalImpl?wsdl");
     ...
     */
    @WebEndpoint(name = "ProductServiceLocalImplPort")
    public ProductServiceWs getProductServiceLocalImplPort() {
        return super.getPort(new QName("http://services.vlsv.ru/", "ProductServiceLocalImplPort"), ProductServiceWs.class);
    }
     ...
     */
    @WebEndpoint(name = "ProductServiceLocalImplPort")
    public ProductServiceWs getProductServiceLocalImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.vlsv.ru/", "ProductServiceLocalImplPort"), ProductServiceWs.class, features);
    }
